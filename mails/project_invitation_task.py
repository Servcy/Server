...
# # Module imports
# from servcy.db.models import Project, ProjectMemberInvite, User
# from servcy.license.utils.instance_value import get_email_configuration
...
#         subject = f"{user.first_name or user.display_name or user.email} invited you to join {project.name} on Servcy"
